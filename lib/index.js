(function() {
  ...
  modulize = (function() {
    ...
    if (!isFunc(getBuf)) throw new Error("something wrong!!!");
    getBuf().length = 0;
    wrap = function(func) {
      return function() {
        var bufIdx;
        ...
        return getBuf().splice(bufIdx).join('');
      };
    };
    _ref = mdl.exports;
    _results = [];
  ...
  module.exports = JadeModuleCompiler = (function() {
    ...
    JadeModuleCompiler.prototype.compile = function(data, path, callback) {
      var error, jadeFunc, result, _ref, _ref2;
      try {
        ...
        jadeFunc = jade.compile(data, {
          ...
          client: true,
          filename: path,
          pretty: !!((_ref = this.config.plugins) != null ? (_ref2 = _ref.jade) != null ? _ref2.pretty : void 0 : void 0)
        });
